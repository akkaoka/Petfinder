      ...
      <body class="skin-black">
        ...
        <header class="header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                            ...
                            <div class="panel">
                                <header class="panel-heading">
                                    ...
                                    <div class="text-left" style="margin-top: 10px;">
                                     <a href="<?php echo base_url(); ?>index.php/admin/insertadoption" class="btn btn-sm btn-warning">Add More &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </header>
                 ...
                 <table id="example2" class="table table-hover table-bordered">
                  <thead>
                      <tr>
                          ...
                          <th><center><span>Species</span></center></th>
                          <th><center><span>Gender</span></center></th>
                          <th><center><span>Age</span></center></th>
                          <th><center><span>Condition</span></center></th>
                          <th><center><span>Size</span></center></th>
                ...
                ?>
                    <tr>
                    <td><center><img src="<?php echo base_url("images/binatang/$gambar") ?>" style="max-width: 50px; max-height: 80px;"></center></td>
                    <td><center><?php echo "$nama_binatang"; ?></center></td>
                    <td><center><?php echo "$jenis_binatang"; ?></center></td>
                    <td><center><?php echo "$gender"; ?></center></td>
                    <td><center><?php echo "$umur"; ?></center></td>
                    <td><center><?php echo "$kondisi"; ?></center></td>
                    <td><center><?php echo "$size"; ?></center></td>
                    <td>
                    <center>
                    <div id="thanks">
                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit" href="<?php echo base_url(); ?>/index.php/admin/edit_adopt?id_binatang=<?php echo $id_binatang; ?>">
                    	<span class="glyphicon glyphicon-edit"></span>
                    </a>
                    <a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Delete" href="<?php echo base_url(); ?>/index.php/admin/delete_adopt?id_binatang=<?php echo $id_binatang; ?>"><span class="glyphicon glyphicon-trash">
                    </a>
                    </center>
                   	</td>
                   	</tr>
