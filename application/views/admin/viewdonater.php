            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <section class="content">
                 ...
                 <table id="example" class="table table-hover table-bordered">
                  <thead>
                      <tr>
                          <th><center><span>Donater</span></center></th>
                          <th><center><span>Account Name</span></center></th>
                          <th><center><span>Account Number</span></center></th>
                          <th><center><span>Bank</span></center></th>
                          <th><center><span>Quantity</span></center></th>
                          <th><center><span>Date</span></center></th>
                          <th><center><span>Action</span></center></th>
                      </tr>
                  </thead>
             <?php
                foreach ($donater as $value) {
                      $id_donasi=$value->id_donasi;
                      $nama=$value->nama;
                      $nama_rek=$value->nama_rek;
                      $no_rek=$value->no_rek;
                      $nama_bank=$value->nama_bank;
                      $jumlah_donasi=$value->jumlah_donasi;
                      $tgl_donasi=$value->tgl_donasi;
              ?>
                    <tbody>
                    <tr>
                    <td><center><?php echo "$nama"; ?></center></td>
                    <td><center><?php echo "$nama_rek"; ?></center></td>
                    <td><center><?php echo "$no_rek"; ?></center></td>
                    <td><center><?php echo "$nama_bank"; ?></center></td>
                    <td><center><?php echo "$jumlah_donasi"; ?></center></td>
                    <td><center><?php echo "$tgl_donasi"; ?></center></td>
                    <td>
                    <center>
                    <div id="thanks">
                    <a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Delete" href="<?php echo base_url(); ?>/index.php/admin/delete_donate?id_donasi=<?php echo $id_donasi; ?>"><span class="glyphicon glyphicon-trash">
                    </a>
                    </center>
                    </td>
                    </tr>
